...
const AboutUS = () => {
  return (
    <div>
      ...
      <p>Bienvenidos a PrimeMart Online, tu tienda de confianza para realizar tus compras diarias de manera rápida, segura y conveniente. 
        ...
        una amplia gama de productos orgánicos y sostenibles. ¡Gracias por elegirnos y permitirnos ser parte de tu día a día!</p>
    </div>
  );
};
